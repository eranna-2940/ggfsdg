    ...
    <div className="App">
          ...
          <div className='nav1'>
              ...
              <div className='footer'>
                    <a className='footer-head'  href='https://starterhelp.orangehrm.com/hc/en-us/articles/5295915003666-OrangeHRM-Starter-Installation-Guide'>
          ...
          <div>    
              ...
              <div>    
                     <label className="datalabel">
                     <input type="radio" value="upgrade" name="option" />
