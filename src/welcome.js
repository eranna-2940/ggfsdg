    ...
    <div className="App">
          ...
          <div className='midd-content'>
            ...
            <div className='content'>
               <h5 className='hrmorange'> Welcome to InfoHRM Starter Version 5.3 Setup Wizard </h5>
              <p className='cpara1'>This setup wizard will guide through the steps necessary to install/ upgrade InfoHRM Starter components and their dependencies</p>
              <br/>
          ...
          <div>    
              ...
              <p className='inputp'>Choose this option if you are installing InfoHRM Starter for the first time </p>
              <div>    
                     <label className="datalabel">
              ...
              <p className='inputp'>Choose this option if you are already using a prior version of InfoHRM Starter(version 4.0 onwards) and would like to upgrade to<b> version  5.3</b></p>
          </div>
